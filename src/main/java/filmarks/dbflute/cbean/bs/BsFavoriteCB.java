...
public class BsFavoriteCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<FavoriteCQ> {
         ...
         */
        public HpSDRFunction<PostCB, FavoriteCQ> derivedPost() {
            assertDerived("postList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<PostCB> sq, FavoriteCQ cq, String al, DerivedReferrerOption op)
