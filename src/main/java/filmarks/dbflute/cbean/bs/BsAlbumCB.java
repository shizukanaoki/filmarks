 ...
 */
public class BsAlbumCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected AlbumCQ _conditionQuery;
     ...
     */
    public AlbumCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public AlbumCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected AlbumCQ doGetConditionQuery() {
    ...
    protected AlbumCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected AlbumCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        AlbumCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected AlbumCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new AlbumCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<AlbumCB> unionCBLambda) {
        final AlbumCB cb = new AlbumCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final AlbumCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<AlbumCB> unionCBLambda) {
        final AlbumCB cb = new AlbumCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final AlbumCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     ... = <span style="color: #553000">album</span>.<span style="color: #CC4747">getArtist()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<AlbumCQ> {
        ...
        @Override
        protected String getTableDbName() { return "ALBUM"; }
        /**
         ...
         */
        public HpSDRFunction<CommentCB, AlbumCQ> derivedComment() {
            assertDerived("commentList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<CommentCB> sq, AlbumCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<AlbumCB, AlbumCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<AlbumCB> sq, AlbumCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public AlbumCB dreamCruiseCB() {
        AlbumCB cb = new AlbumCB();
        cb.xsetupForDreamCruise((AlbumCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<AlbumCB> columnQuery(final SpecifyQuery<AlbumCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected AlbumCB xcreateColumnQueryCB() {
        AlbumCB cb = new AlbumCB();
        cb.xsetupForColumnQuery((AlbumCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<AlbumCB> orCBLambda) {
        xorSQ((AlbumCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<AlbumCB> andCBLambda) {
        xorSQAP((AlbumCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return AlbumCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return AlbumCQ.class.getName(); }
