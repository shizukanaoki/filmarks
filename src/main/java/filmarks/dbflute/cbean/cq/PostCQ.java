...
import filmarks.dbflute.cbean.cq.bs.BsPostCQ;

/**
 * The condition-query of POST.
 * <p>
 ...
 */
public class PostCQ extends BsPostCQ {
     ...
     */
    public PostCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
