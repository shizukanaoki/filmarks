...
import filmarks.dbflute.cbean.cq.bs.BsAlbumCQ;

/**
 * The condition-query of ALBUM.
 * <p>
 ...
 */
public class AlbumCQ extends BsAlbumCQ {
     ...
     */
    public AlbumCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
