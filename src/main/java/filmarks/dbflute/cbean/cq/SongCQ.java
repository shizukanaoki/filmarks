...
import filmarks.dbflute.cbean.cq.bs.BsSongCQ;

/**
 * The condition-query of SONG.
 * <p>
 ...
 */
public class SongCQ extends BsSongCQ {
     ...
     */
    public SongCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
